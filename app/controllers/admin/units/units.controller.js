...
const { getSelectUnits, getIdUnitSelectAxis, getSelectIdUnitsObjectives, getSelectIdUnitsSkills, getSelectUnitsAttitudes } = require('./get.js');
...
module.exports = {
    ...
    updatePlanningUnit: async function (req, res) {
